...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the default timezone for the application, which
    ...
    */
    ...
    | request to the application. Feel free to add services to
    | this array to grant expanded functionality to the applications.
    |
    */
